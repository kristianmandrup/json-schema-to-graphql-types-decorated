# JSON Schema to GraphQL types with transforms
...
We need a way to add transform declarations in a declarative way so they can be included in the generated types.

We need to allow supplying an extra config with meta data for directives to be merged into output
